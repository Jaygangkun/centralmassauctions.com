          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo site_url(); ?>/estate-sale/">Estate Sales</a></li>
                <li><a href="<?php echo site_url(); ?>/estate-appraisals">Estate Appraisals</a></li>
                <li><a href="<?php echo site_url(); ?>/flyer">Flyer</a></li>
                <li><a href="<?php echo site_url(); ?>/estate-auction-news">Estate Auction News</a></li>
                <li><a href="<?php echo site_url(); ?>/auction-previews">Auction Previews</a></li>
