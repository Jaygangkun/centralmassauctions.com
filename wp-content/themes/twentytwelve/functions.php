...
function twentytwelve_widgets_init() {
	...
	register_sidebar( array(
        ...
        register_sidebar( array(
		'name' => __( 'Header-menu', 'twentytwelve' ),
		'id' => 'header-menu',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '',
		'after_widget' => '',
	...
	register_sidebar( array(
		'name' => __( 'Home Page After Services Area', 'twentytwelve' ),
		'id' => 'after-service',
		'description' => __( 'Display only on Static Front Page', 'twentytwelve' ),
	...
	register_sidebar( array(
		'name' => __( 'Menu Backup', 'twentytwelve' ),
		'id' => 'backup',
		'description' => __( 'This is for backup only', 'twentytwelve' ),
		'before_widget' => '<section>',
		'after_widget' => '</section>',
		'before_title' => '',
		'after_title' => '',
...
function servicelogoheading1_setting() 
    {  $options = get_option('plugin_options');  
       echo "<input name='plugin_options[servlogoheading1]' type='text' class='intext' value='{$options['servlogoheading1']}' />";
    }
function servicelogoheading2_setting() 
    {  $options = get_option('plugin_options');  
       echo "<input name='plugin_options[servlogoheading2]' type='text' class='intext' value='{$options['servlogoheading2']}' />";
    }
function address_setting() 
    {  $options = get_option('plugin_options');  
       echo "<textarea name='plugin_options[address]' class='textin'>{$options['address']}</textarea>";
    }
function service1_heading_setting() 
    {  $options = get_option('plugin_options');  
        echo "<input name='plugin_options[service1_heading]' type='text' class='intext' value='{$options['service1_heading']}' />";
    }
function service2_heading_setting() 
    {  $options = get_option('plugin_options');  
        echo "<input name='plugin_options[service2_heading]' type='text' class='intext' value='{$options['service2_heading']}' />";
    }
function service3_heading_setting() 
    {  $options = get_option('plugin_options');  
        echo "<input name='plugin_options[service3_heading]' type='text' class='intext' value='{$options['service3_heading']}' />";
    }
function service4_heading_setting() 
    {  $options = get_option('plugin_options');  
        echo "<input name='plugin_options[service4_heading]' type='text' class='intext' value='{$options['service4_heading']}' />";
    }
function service1_box_setting() 
    {  $options = get_option('plugin_options');  
      echo "<textarea name='plugin_options[servicebox1_heading]' class='textin'>{$options['servicebox1_heading']}</textarea>";
    }
function service2_box_setting() 
    {  $options = get_option('plugin_options');  
        echo "<textarea name='plugin_options[servicebox2_heading]' class='textin'>{$options['servicebox2_heading']}</textarea>";
    }
function service3_box_setting() 
{  $options = get_option('plugin_options');  
   echo "<textarea name='plugin_options[servicebox3_heading]' class='textin'>{$options['servicebox3_heading']}</textarea>";
}
function service4_box_setting() 
{  $options = get_option('plugin_options');  
   echo "<textarea name='plugin_options[servicebox4_heading]' class='textin'>{$options['servicebox4_heading']}</textarea>";
}
...
{  $options = get_option('plugin_options');  
   echo "<textarea name='plugin_options[slidertext_heading]' class='textin'>{$options['slidertext_heading']}</textarea>";
}
function seller_box_setting() 
{  $options = get_option('plugin_options');  
   echo "<textarea name='plugin_options[seller_heading]' class='textin'>{$options['seller_heading']}</textarea>";
}
function buyer_box_setting() 
{  $options = get_option('plugin_options');  
   echo "<textarea name='plugin_options[buyer_heading]' class='textin'>{$options['buyer_heading']}</textarea>";
}
function custom_colors() {
   echo '<style type="text/css">
           .textin{margin: 2px;width:59%;height: 142px;}
            .intext{width: 59%;}
         </style>';
}
...
function my_acf_google_map_api( $api ){
	...
	$api['key'] = 'AIzaSyD7_akL6wSECUm5ZHj34SVTEZsLZgBKDgc';
