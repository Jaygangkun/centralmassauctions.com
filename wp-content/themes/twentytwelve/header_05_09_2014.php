          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo site_url(); ?>/antique-auctions/">Antique Estate Auctions</a></li>
                <li><a href="<?php echo site_url(); ?>/services/estate-sales.php">Estate Sales</a></li>
                <li><a href="<?php echo site_url(); ?>/services/estate-appraisals.php">Estate Appraisals</a></li>
                <li><a href="<?php echo site_url(); ?>/flyer.php">Flyer</a></li>
                <li><a href="<?php echo site_url(); ?>/news.php">Estate Auction News</a></li>
                <li><a href="<?php echo site_url(); ?>/previews">Auction Previews</a></li>
